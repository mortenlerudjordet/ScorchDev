    ...
    Try
    {
        ...
        foreach($VariableName in $Variables.Keys)
        {
            ...
            if(Test-IsNullOrEmpty $SmaVariable.VariableId.Guid)
            {
                ...
                $VariableDescription = "$($Variable.Description)`n`r__RepositoryName:$($RepositoryName);CurrentChangesetID:$($CurrentChangesetID);__"
                $NewVersion = $True
            }
            else
            {
        ...
        foreach($ScheduleName in $Schedules.Keys)
        {
            ...
            try
            {
                ...
                if(Test-IsNullOrEmpty $SmaSchedule.ScheduleId.Guid)
                {
                    ...
                    $ScheduleDescription = "$($Schedule.Description)`n`r__RepositoryName:$($RepositoryName);CurrentChangesetID:$($CurrentChangesetID);__"
                    $NewVersion = $True
                }
                else
                {
